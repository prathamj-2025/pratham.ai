...
GREETING = (
    ...
    "Ask me anything about his education, work experience, projects, or "
    "career goals. What would you like to know?"
)
...
# UI
# ──────────────────────────────────────────────────────────────────────────
st.set_page_config(page_title=f"Chat with {ASSISTANT_NAME}", page_icon="💬", layout="centered")
...
# Force-close feedback on every fresh page load (not on reruns)
